...
type CoinRecord struct {
	...
	Consume uint32 `protobuf:"varint,1,opt,name=consume,proto3" json:"consume,omitempty"`            // 消耗的金币数
...
func (x *CoinRecord) GetConsume() uint32 {
	if x != nil {
		return x.Consume
	}
	return 0
...
var file_user_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x6e, 0x73, 0x75, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x63,
