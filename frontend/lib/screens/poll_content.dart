...
class PollContent extends StatefulWidget {
  ...
  const PollContent({super.key, required this.postUserID, required this.userID});

  @override
  PollContentState createState() => PollContentState();
}

class PollContentState extends State<PollContent>
